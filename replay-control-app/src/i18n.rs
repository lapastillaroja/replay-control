...
pub fn t(locale: Locale, key: &str) -> &'static str {
    ...
    match key {
        ...
        "metadata.no_data" => "No metadata imported yet",
        "metadata.import" => "Import",
        "metadata.import_launchbox" => "Import LaunchBox",
        "metadata.importing" => "Importing...",
        "metadata.import_hint" => "Path to LaunchBox Metadata.xml on the server filesystem",
        "metadata.import_success" => "Import complete",
        "metadata.matched" => "matched",
        "metadata.inserted" => "inserted",
        "metadata.clear" => "Clear All Metadata",
        "metadata.clearing" => "Clearing...",
        "metadata.cleared" => "Metadata cleared",
        "metadata.confirm_clear" => "Clear all cached metadata? Game detail pages will no longer show descriptions and ratings until you re-import.",
        "metadata.import_started" => "Import started",
        "metadata.import_already_running" => "An import is already running",
        ...
        "metadata.coverage_count" => "With Metadata",
        "metadata.no_coverage" => "No coverage data available. Import metadata first.",
        "metadata.auto_import_hint" => "Place Metadata.xml in the .replay-control folder on your storage for automatic import on startup.",
        "metadata.attribution" => "Attribution",
        "metadata.attribution_text" => "Game descriptions and ratings provided by LaunchBox. Data is cached locally for offline use and is not redistributed.",
