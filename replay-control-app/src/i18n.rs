...
pub fn t(locale: Locale, key: &str) -> &'static str {
    ...
    match key {
        ...
        "game_detail.find_manual" => "Find Manual",
        "game_detail.searching_manual" => "Searching...",
        "game_detail.save_manual" => "Save",
        ...
        "game_detail.play_order" => "Play Order",
        "game_detail.not_in_library" => "not in library",
        "game_detail.n_of_m" => "{} of {}",
