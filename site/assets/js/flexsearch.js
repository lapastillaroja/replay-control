/* OVERRIDE: @thulite/doks-core flexsearch.js — fixes search-index.json path
 * to use relURL for subpath deployments (GitHub Pages at /replay-control/).
 * Theme uses site.LanguagePrefix which doesn't include baseURL subpath.
 * Remove this file if the theme fixes the fetch URL to use relURL.
 *
 * Changed line ~126: fetch("{{ site.LanguagePrefix }}/search-index.json")
